...
DOCUMENTS_BACKUP_PREFIX = (
    __get_string("PAPERLESS_DOCUMENTS_BACKUP_PREFIX", "documents-backup")
    or "documents-backup"
).strip("/")
DOCUMENTS_BACKUP_S3_BUCKET = __get_string("PAPERLESS_DOCUMENTS_BACKUP_S3_BUCKET")
DOCUMENTS_BACKUP_S3_ENDPOINT_URL = __get_string(
    "PAPERLESS_DOCUMENTS_BACKUP_S3_ENDPOINT_URL",
)
DOCUMENTS_BACKUP_S3_ACCESS_KEY_ID = __get_string(
    "PAPERLESS_DOCUMENTS_BACKUP_S3_ACCESS_KEY_ID",
)
DOCUMENTS_BACKUP_S3_SECRET_ACCESS_KEY = __get_string(
    "PAPERLESS_DOCUMENTS_BACKUP_S3_SECRET_ACCESS_KEY",
)
DOCUMENTS_BACKUP_S3_REGION_NAME = __get_string(
    "PAPERLESS_DOCUMENTS_BACKUP_S3_REGION_NAME",
)
DOCUMENTS_BACKUP_S3_DEFAULT_ACL = __get_string(
    "PAPERLESS_DOCUMENTS_BACKUP_S3_DEFAULT_ACL",
)
DOCUMENTS_BACKUP_S3_CUSTOM_DOMAIN = __get_string(
    "PAPERLESS_DOCUMENTS_BACKUP_S3_CUSTOM_DOMAIN",
)
DOCUMENTS_BACKUP_S3_URL_PROTOCOL = __get_string(
    "PAPERLESS_DOCUMENTS_BACKUP_S3_URL_PROTOCOL",
    "https:",
)
DOCUMENTS_BACKUP_S3_ADDRESSING_STYLE = __get_string(
    "PAPERLESS_DOCUMENTS_BACKUP_S3_ADDRESSING_STYLE",
)
DOCUMENTS_BACKUP_S3_QUERYSTRING_AUTH = __get_boolean(
    "PAPERLESS_DOCUMENTS_BACKUP_S3_QUERYSTRING_AUTH",
    "false",
)
DOCUMENTS_BACKUP_S3_USE_SSL = __get_boolean(
